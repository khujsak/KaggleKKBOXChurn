# -*- coding: utf-8 -*-
"""
Created on Wed Dec 13 22:15:31 2017
...
user_logs = pd.read_csv('./Logs_Processed/user_logs_march_to_april.csv')
user_logs2=pd.read_csv('./Logs_Processed/user_logs2_march_to_april.csv')
...
user_logs = pd.read_csv('./Logs_Processed/user_logs_before_march.csv')
user_logs2=pd.read_csv('./Logs_Processed/user_logs2_before_march.csv')
...
transactions_last=pd.read_csv('./Trans_Processed/transactions_last_march.csv')
transactions_last=transactions_last.drop(transactions_last.columns[0], axis=1)




train_w=pd.read_csv('test_tr_windowed.csv')
