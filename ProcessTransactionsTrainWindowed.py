...
train=pd.read_csv('train_with_members.csv')
train=train.drop(train.columns[0], axis=1)
train_orig=pd.read_csv('train_orig_with_members.csv')
train_orig=train_orig.drop(train_orig.columns[0], axis=1)

date1=dt.date(2016, 12, 1)
date2=dt.date(2017, 2, 1)
...
train.to_csv('train_tr_windowed.csv')
train_orig.to_csv('train_orig_tr_windowed.csv')
