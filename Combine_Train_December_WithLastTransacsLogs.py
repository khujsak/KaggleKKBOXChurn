...
user_logs2=pd.read_csv('./Logs_Processed/user_logs2_december_to_january.csv')
...
user_logs = pd.read_csv('./Logs_Processed/user_logs_before_december.csv')
...
transactions_last=pd.read_csv('./Trans_Processed/transactions_last_december.csv')
...
train_w=pd.read_csv('train_december_tr_windowed.csv')
...
train=pd.read_csv('train_december_tr.csv')
...
train.to_csv('train_december_rdy.csv')