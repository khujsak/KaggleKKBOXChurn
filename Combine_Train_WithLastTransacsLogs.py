...
user_logs = pd.read_csv('./Logs_Processed/user_logs_february_to_march.csv')
user_logs2=pd.read_csv('./Logs_Processed/user_logs2_february_to_march.csv')
...
user_logs = pd.read_csv('./Logs_Processed/user_logs_before_february.csv')
user_logs2=pd.read_csv('./Logs_Processed/user_logs2_before_february.csv')
...
transactions_last=pd.read_csv('./Trans_Processed/transactions_last_february.csv')
...
train_w=pd.read_csv('train_tr_windowed.csv')
...
train=pd.read_csv('train_tr.csv')
